...
// Central area has the most optimal root to get minimum height tree , leaf are worst
// Answer can have at most 2 roots or 1 root
// So processing each level from leaf to get central root
//T.C : O(V+E)
//S.C : O(V+E)
class Solution {
public:
